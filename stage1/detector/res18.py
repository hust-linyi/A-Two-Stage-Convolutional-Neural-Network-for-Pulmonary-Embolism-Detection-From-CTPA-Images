...
config = {}
config['anchors'] = [10., 30., 60.] #[5., 10., 20.]
config['chanel'] = 1
...
config['reso'] = 1
config['sizelim'] = 6 #3 #6. #mm
config['sizelim2'] = 20 #30
config['sizelim3'] = 30 #40
config['aug_scale'] = True
config['r_rand_crop'] = 0.3
config['pad_value'] = 170
config['augtype'] = {'flip':True,'swap':False,'scale':True,'rotate':True}
config['blacklist'] = []
